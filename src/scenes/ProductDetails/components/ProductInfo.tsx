...
export default function ProductInfo(props: Props) {
  let {
    product: { title, description, price, discount, quantityAvailable = 0 }, options, quantity, selectedOptions, onChangeQuantity, onSelectionOptionChange,
  } = props;
    ...
    <>
      ...
      <View style={styles.paddingHorizontal}>
        ...
        <TextInput
          ...
          onBlur={() => {}}
          onChangeText={(value: string) =>onChangeQuantity(valueBetweenZeroToMax(parseInt(value, 10)))}
