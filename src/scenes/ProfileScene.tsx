...
export default function ProfileScene() {
  ...
  let { data: authenticatedUser,  error: getAuthenticatedUserError, loading: getAuthenticatedUserLoading,
  ...
  let { deactivateCustomerToken } = useDeactivateCustomerToken({
    ...
    onCompleted: () => setLogoutLoading(false),
  });
  ...
  if (authenticatedUser && authenticatedUser.authenticatedUser) {
