...
import { CountryModal, ModalBottomSheetMessage ,StatesModal} from '../../components';
import {
  Button,
...
export default function AddEditAddressScene() {
  ...
  let [isStateModalVisible, setStateModalVisible] = useState(false);
  ...
  let onPressCountry = (country: string ,code: any) => {
    toggleCountryModal();
    // eslint-disable-next-line eqeqeq
    if(addressData.country == country || selectedCountryCode == code){
  ...
  let onPressState = (provinceData: any) => {
    let province = provinceData.name
    toggleStateModal();
  ...
  let onPressSaveAddress = async () => {
    if (address === undefined) {
      ...
      let customerUserErrors = result?.data?.customerAddressCreate?.customerUserErrors;
  ...
  return (
    <KeyboardAvoidingView keyboardVerticalOffset={bottomButtonHeight}>
      ...
      <StatesModal
        ...
        statesVisible={isStateModalVisible}
